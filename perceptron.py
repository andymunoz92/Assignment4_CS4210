    ...
    for b in r: #iterates over r
        ...
        for a in range(2): #iterates over the algorithms
            ...
            if accuracy > ha:
                ha = accuracy
                if a == 0:
                    print("Highest Perceptron accuracy so far: {}, Parameters: learning rate={}, shuffle={}".format(ha, w, b))
                else:
                    print("Highest MLP accuracy so far: {}, Parameters: learning rate={}, shuffle={}".format(ha, w, b))
